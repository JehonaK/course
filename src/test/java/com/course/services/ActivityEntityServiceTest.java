...
public class ActivityEntityServiceTest {
    ...
    public void setup() {
        ...
        activityEntity = new ActivityEntity("3b07ff1a-93d7-4b72-9a37-e19ef6993ede",
                "Auto activityEntity",
                deadline,
                "This is a test activityEntity",
                false,
                GradeSystem.A_F,
                "A",
                courseEntity
                );
        courseEntity.setActivities(Arrays.asList(activityEntity));
    ...
    public void saveActivity_byActivity_returnActivity() {
        assertThat(activityService.save(activityEntity)).isEqualTo(activityEntity);
    }

    @Test
    public void getActivities_byCourseId_returnListOfActivities() {
        assertThat(activityService.getActivitiesByCourseId("49a493f3-956e-4b1d-956d-9db6df76967f")).containsExactly(activityEntity);
    }
}
